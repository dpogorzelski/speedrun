...
var setKeyCmd = &cobra.Command{
	Use:     "set",
	Short:   "Set key in the project's or instance metadata",
...
// 	Use:   "remove",
// 	Short: "Remove key from the project's metadata",
// 	RunE:  removeKey,
// }

func init() {
	setKeyCmd.Flags().String("filter", "", "Set the key only on matching instances")
	// removeKeyCmd.Flags().String("filter", "", "Remove the key only from matching instances")
